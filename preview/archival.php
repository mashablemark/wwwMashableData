...
<?php if(strrpos ($_SERVER["REQUEST_URI"], 'dev')!==FALSE){ ?>
            ...
            <script type="text/javascript" src="/embed/mashabledata_embedtools.js?v=<?=$workbenchVersion?>"></script>
<?php } else { ?>
    <script type="text/javascript" src="/embed/mashabledata_embedtools.min.js?v=<?=$workbenchVersion?>"></script>
<?php }  ?>
        </head>
...
<div style="border: thin solid black;color: #00008b;margin: 10px;padding: 10px;">
    ...
    &lt;script type="text/javascript" src="<a href="//www.mashabledata.com/embed/mashabledata_embedtools.min.js">/embedder/mashabledata_embedtools.min.js</a>&gt;&lt;/script&gt;<br />
    <br />
    &lt;!--CSS files--&gt;<br />
    &lt;link  rel="stylesheet" href="//www.mashabledata.com/global/css/smoothness/jquery-ui-1.9.2.custom.css" /&gt;<br />
    &lt;link rel="stylesheet" href="<a href="//www.mashabledata.com/embed/mashabledata_embedtools.css">/embedder/mashabledata_embedtools.css</a> /&gt;<br />
</div>
